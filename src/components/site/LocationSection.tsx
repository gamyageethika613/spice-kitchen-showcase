...
export function LocationSection() {
  const hoursStatus = useLondonTimeStatus();

  return (
    <section
      id="location"
      className="scroll-mt-24 py-20 sm:py-24 px-5 sm:px-6 bg-gradient-to-b from-background to-background/80"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs uppercase tracking-[0.4em] text-gold mb-4">Contact / Location</p>
          <h2 className="font-serif text-4xl sm:text-6xl text-gradient-gold mb-4">
            Visit Karthikeya Spice Kitchen
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:col-span-2 ornate-border glass p-8 space-y-6 rounded-2xl"
          >
            <div>
            ...
            <div className="space-y-4 text-cream/85">
              ...
              <div className="flex gap-3 items-center">
                ...
                <a href={RESTAURANT.phoneLink} className="hover:text-gold transition">
                  {RESTAURANT.phone}
                </a>
              </div>
              <div className="flex gap-3 items-center">
            ...
            <div className="pt-2">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-gradient-gold text-primary-foreground font-medium hover:scale-[1.02] transition shadow-gold"
              >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="lg:col-span-3 ornate-border overflow-hidden min-h-[380px] relative flex flex-col items-center justify-center text-center p-10 bg-gradient-to-br from-gold/5 via-background to-saffron/5 rounded-2xl"
          >
            ...
            <div className="relative z-10 max-w-sm">
              ...
              <h3 className="font-serif text-2xl text-gradient-gold mb-3">Directions in One Tap</h3>
              ...
              <p className="text-xs text-cream/40 mt-4 uppercase tracking-[0.2em]">
                Opens in a new tab
              </p>
            </div>
          </motion.div>
