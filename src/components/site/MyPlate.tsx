              ...
              {items.length === 0 ? (
                <div className="text-center py-16 text-cream/50">
                  ...
                  <p className="text-xs mt-2">
                    Browse the menu and tap "Add to My Plate" on dishes you love.
                  </p>
                </div>
              ) : (
                  ...
                  {items.map((it) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 rounded-full border border-gold/40 bg-gold/5 px-1 py-0.5">
                        <button
                          onClick={() => dec(it.id)}
                          className="w-7 h-7 rounded-full text-gold hover:bg-gold/20 inline-flex items-center justify-center transition"
                          aria-label="Decrease"
                        >
                          <Minus size={13} />
                        </button>
                        <span className="font-serif text-sm text-gold min-w-[1.5rem] text-center">
                          {it.qty}
                        </span>
                        <button
                          onClick={() => inc(it.id)}
                      ...
                      <button
                        ...
                        className="text-cream/50 hover:text-destructive p-1.5 rounded"
                        aria-label="Remove"
                      >
                        <Trash2 size={16} />
                      </button>
